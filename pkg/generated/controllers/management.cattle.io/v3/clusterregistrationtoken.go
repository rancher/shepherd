...
func (a *clusterRegistrationTokenGeneratingHandler) isNewResourceVersion(obj *v3.ClusterRegistrationToken) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *clusterRegistrationTokenGeneratingHandler) storeResourceVersion(obj *v3.ClusterRegistrationToken) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
