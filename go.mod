...
replace (
	...
	github.com/rancher/apiserver => github.com/krunalhinguu/apiserver v1.29.0-rancher4
...
replace (
	// point to 1.29 fork/branch for codegen
	github.com/rancher/rancher/pkg/apis => github.com/krunalhinguu/rancher/pkg/apis v0.0.0-20240426011339-c23c314199d6
