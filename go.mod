...
require (
	...
	github.com/rancher/aks-operator v1.11.0-rc.4
	github.com/rancher/apiserver v0.0.0-20240604183424-8c448886365e
	github.com/rancher/eks-operator v1.11.0-rc.3
	...
	github.com/rancher/rancher/pkg/apis v0.0.0-20250305200108-751e3c1e6b9d
