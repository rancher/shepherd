...
type MachineDeploymentController interface {
	generic.ControllerInterface[*v1beta2.MachineDeployment, *v1beta2.MachineDeploymentList]
}
...
type MachineDeploymentClient interface {
	generic.ClientInterface[*v1beta2.MachineDeployment, *v1beta2.MachineDeploymentList]
}
...
type MachineDeploymentCache interface {
	generic.CacheInterface[*v1beta2.MachineDeployment]
}
...
type MachineDeploymentStatusHandler func(obj *v1beta2.MachineDeployment, status v1beta2.MachineDeploymentStatus) (v1beta2.MachineDeploymentStatus, error)
...
type MachineDeploymentGeneratingHandler func(obj *v1beta2.MachineDeployment, status v1beta2.MachineDeploymentStatus) ([]runtime.Object, v1beta2.MachineDeploymentStatus, error)
...
func (a *machineDeploymentStatusHandler) sync(key string, obj *v1beta2.MachineDeployment) (*v1beta2.MachineDeployment, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *machineDeploymentGeneratingHandler) Remove(key string, obj *v1beta2.MachineDeployment) (*v1beta2.MachineDeployment, error) {
	if obj != nil {
		return obj, nil
	}

	obj = &v1beta2.MachineDeployment{}
...
func (a *machineDeploymentGeneratingHandler) Handle(obj *v1beta2.MachineDeployment, status v1beta2.MachineDeploymentStatus) (v1beta2.MachineDeploymentStatus, error) {
...
func (a *machineDeploymentGeneratingHandler) isNewResourceVersion(obj *v1beta2.MachineDeployment) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *machineDeploymentGeneratingHandler) storeResourceVersion(obj *v1beta2.MachineDeployment) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
