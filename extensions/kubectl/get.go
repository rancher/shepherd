...
func GetUnstructuredFromFlags(s *session.Session, masterURL, kubeconfigPath, name, n string, gvr schema.GroupVersionResource) (*v1Unstructured.Unstructured, error) {
