...
type ClusterController interface {
	generic.ControllerInterface[*v1beta2.Cluster, *v1beta2.ClusterList]
}

// ClusterClient interface for managing Cluster resources in Kubernetes.
type ClusterClient interface {
	generic.ClientInterface[*v1beta2.Cluster, *v1beta2.ClusterList]
}

// ClusterCache interface for retrieving Cluster resources in memory.
type ClusterCache interface {
	generic.CacheInterface[*v1beta2.Cluster]
}

// ClusterStatusHandler is executed for every added or modified Cluster. Should return the new status to be updated
type ClusterStatusHandler func(obj *v1beta2.Cluster, status v1beta2.ClusterStatus) (v1beta2.ClusterStatus, error)
...
type ClusterGeneratingHandler func(obj *v1beta2.Cluster, status v1beta2.ClusterStatus) ([]runtime.Object, v1beta2.ClusterStatus, error)
...
func (a *clusterStatusHandler) sync(key string, obj *v1beta2.Cluster) (*v1beta2.Cluster, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *clusterGeneratingHandler) Remove(key string, obj *v1beta2.Cluster) (*v1beta2.Cluster, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *clusterGeneratingHandler) Handle(obj *v1beta2.Cluster, status v1beta2.ClusterStatus) (v1beta2.ClusterStatus, error) {
...
func (a *clusterGeneratingHandler) isNewResourceVersion(obj *v1beta2.Cluster) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *clusterGeneratingHandler) storeResourceVersion(obj *v1beta2.Cluster) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
