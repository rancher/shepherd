...
func UpdateUser(client *rancher.Client, existingUser *v3.User, updatedUser *v3.User) (*v3.User, error) {
	...
	userUnstructured, err := adminUserResource.Get(context.TODO(), existingUser.Name, metav1.GetOptions{})
	if err != nil {
		return nil, err
	}
...
func UpdateUserAttributes(client *rancher.Client, existingUserAttribute *v3.UserAttribute, updatedUserAttribute *v3.UserAttribute) (*v3.UserAttribute, error) {
	...
	userUnstructured, err := adminUserAttributeResource.Get(context.TODO(), existingUserAttribute.Name, metav1.GetOptions{})
	if err != nil {
		return nil, err
	}
