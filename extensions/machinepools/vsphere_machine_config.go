...
type VmwarevsphereMachineConfig struct {
	...
	Cloudinit               string   `json:"cloundinit" yaml:"cloundinit"`
...
func NewVSphereMachineConfig(generatedPoolName, namespace string) []unstructured.Unstructured {
	...
	for _, vsphereMachineConfig := range vmwarevsphereMachineConfigs.VmwarevsphereMachineConfig {
		...
		machineConfig.Object["cloundinit"] = vsphereMachineConfig.Cloudinit
		...
		machineConfig.Object["password"] = vmwarevsphereMachineConfigs.Password
		...
		machineConfig.Object["username"] = vmwarevsphereMachineConfigs.Username
		...
		machineConfig.Object["vcenter"] = vmwarevsphereMachineConfigs.Vcenter
		machineConfig.Object["vcenterPort"] = vmwarevsphereMachineConfigs.VcenterPort
...
// GetVsphereMachineRoles returns a list of roles from the given machineConfigs
