...
type MachineGeneratingHandler func(obj *v1beta2.Machine, status v1beta2.MachineStatus) ([]runtime.Object, v1beta2.MachineStatus, error)
...
func (a *machineStatusHandler) sync(key string, obj *v1beta2.Machine) (*v1beta2.Machine, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *machineGeneratingHandler) Remove(key string, obj *v1beta2.Machine) (*v1beta2.Machine, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *machineGeneratingHandler) Handle(obj *v1beta2.Machine, status v1beta2.MachineStatus) (v1beta2.MachineStatus, error) {
...
func (a *machineGeneratingHandler) isNewResourceVersion(obj *v1beta2.Machine) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *machineGeneratingHandler) storeResourceVersion(obj *v1beta2.Machine) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
