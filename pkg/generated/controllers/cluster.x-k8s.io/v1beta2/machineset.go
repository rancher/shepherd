...
type MachineSetGeneratingHandler func(obj *v1beta2.MachineSet, status v1beta2.MachineSetStatus) ([]runtime.Object, v1beta2.MachineSetStatus, error)
...
func (a *machineSetStatusHandler) sync(key string, obj *v1beta2.MachineSet) (*v1beta2.MachineSet, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *machineSetGeneratingHandler) Remove(key string, obj *v1beta2.MachineSet) (*v1beta2.MachineSet, error) {
	if obj != nil {
		return obj, nil
	}

	obj = &v1beta2.MachineSet{}
...
func (a *machineSetGeneratingHandler) Handle(obj *v1beta2.MachineSet, status v1beta2.MachineSetStatus) (v1beta2.MachineSetStatus, error) {
...
func (a *machineSetGeneratingHandler) isNewResourceVersion(obj *v1beta2.MachineSet) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *machineSetGeneratingHandler) storeResourceVersion(obj *v1beta2.MachineSet) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
